...
var svsrc=this._emsvCdnHost+"/"+this._emsvVersion+"/eminv.swf";p.domain=this._domain;p.ns=ns;p.version=this._emsvVersion;p.host=this._emsvHost;p.cdnHost=this._emsvCdnHost;p.visitor=this.getCookie('_em_vt');p.slideFrom=this.surveyDir;var fvars='';for(x in p){fvars+=x+'='+p[x]+'&';}
