...
public class CreateGateDocsProgressBar extends JPanel
    ...
    public CreateGateDocsProgressBar(ConceptRelationsBuilder cons ) {
    ...
    public static void createAndShowGUI(ConceptRelationsBuilder cpns) {
        ...
        JFrame frame = new JFrame("بناء وثائق المعاني ووسمها بالقوالب");
        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);

        //Create and set up the content pane.
        JComponent newContentPane = new CreateGateDocsProgressBar(cpns);
...
//        final CreateGateDocsProgressBar pr=null;
